...
using AzureResourceConnector.Models;
...
namespace AzureResourceConnector.Controllers
{
    ...
    public class ResourcesController : ApiController
    {
            ...
            )
        {
            ...
            resourceListResult = await client.Resources.ListAsync(parameters).ConfigureAwait(continueOnCapturedContext: false);
            ...
            [Metadata("API version", "The version of the API you would like to call to get the resource properties.", VisibilityType.Advanced)]string apiVersion = null)
        {
            ...
            var resource = await client.Resources.GetAsync(ResourceUtilities.GetResourceGroupFromId(id), ResourceUtilities.GetIdentityFromId(id, apiVersion)).ConfigureAwait(continueOnCapturedContext: false);
            ...
            [Metadata("API version", "The version of the API you would like to call to get the resource properties.", VisibilityType.Advanced)]string apiVersion = null)
        {
            ...
            var result = await client.Resources.CreateOrUpdateAsync(ResourceUtilities.GetResourceGroupFromId(id), ResourceUtilities.GetIdentityFromId(id, apiVersion), body.GetGenericResource()).ConfigureAwait(continueOnCapturedContext: false);
            ...
            [Metadata("API version", "The version of the API you would like to call to delete the resource.", VisibilityType.Advanced)]string apiVersion = null)
        {
            ...
            var result = await client.Resources.DeleteAsync(ResourceUtilities.GetResourceGroupFromId(id), ResourceUtilities.GetIdentityFromId(id, apiVersion)).ConfigureAwait(continueOnCapturedContext: false);
